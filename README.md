...
- [**NPU Applications Suite for Linux 6.18.44 (NPU_proj_opi4a_6.18.44)**](./NPU_proj_opi4a_6.18.44): Production edge AI applications for the Orange Pi 4A (Allwinner T527 VIP9000). Includes sub-millisecond thermodynamic neural surrogates (IAPWS-97 steam tables) and real-time vision AI (MobileNet V1 classification & SSD MobileNet object detection).
